...
with open('ncaam-schedule.txt', 'r') as f:
...
while i < len(lines):
    ...
    # Check if it's a date line (format: "Monday, November 3" or similar)
    ...
    if date_match:
        ...
        # Format: 9/13/2025 (no leading zeros)
