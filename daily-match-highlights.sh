...
UEFA_EUROPA_LEAGUE_PLAYLIST="https://www.youtube.com/playlist?list=PLF1A3xcj_XjauRnOMIAX0CQbMhJbbcDvN"
...
run_match_per_game_date "$ROOT_DIR/recaps-manual/daily/uefaeuropaleague.json" "$UEFA_EUROPA_LEAGUE_PLAYLIST" "UEFA Europa League" "uel"
...
echo "- recaps-manual/daily/uefaeuropaleague.json"
