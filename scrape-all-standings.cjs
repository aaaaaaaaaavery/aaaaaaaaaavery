...
async function runScrapers() {
  ...
  // Hardcoded in HTML - commented out
  ...
  // Generate hardcoded standings from Firestore and write to HTML
  console.log('\n📝 Generating hardcoded standings for frontend...\n');
  try {
    ...
    // Don't fail the entire process if hardcoding fails
  }
}
