// index.js - Fetches upcoming 7 days games and writes to Google Sheets only
...
exports.fetchUpcoming7Days = async (req, res) => {
  try {
    ...
    for (let dayOffset = 1; dayOffset <= 7; dayOffset++) {
      ...
      // Filter games based on allowed leagues and exclude finished games
...
if (require.main === module) {
  (async () => {
    ...
    await exports.fetchUpcoming7Days({}, mockRes);
  })();
}
