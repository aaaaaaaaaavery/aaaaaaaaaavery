// cloud-function-yesterday.js
// Cloud Function to fetch yesterday's games for all leagues
...
async function fetchYesterdayAllLeagues() {
  try {
    ...
    const sportsToFetch = [
      ...
      { slug: 'baseball', id: 6, name: 'Baseball' },  // Baseball is sport_id=6
                ...
                tour.EVENTS.forEach((event, eventIndex) => {
                  ...
                  if (status === 'FINISHED') {
                    ...
                    const gameData = {
                      ...
                      'Start Time': startTime * 1000, // Store as milliseconds for frontend compatibility
                      'Home Team': homeTeam,
                      'Away Team': awayTeam,
