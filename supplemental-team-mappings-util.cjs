...
async function getDisplayNameFromSupplemental(teamName, league) {
...
async function doTeamNamesMatch(teamName1, teamName2, league) {
...
async function getAllTeamNameVariations(teamName, league) {
  if (!teamName || !league) return [teamName];
